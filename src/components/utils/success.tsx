    ...
    >
      <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <div className="pointer-events-auto absolute top-[68px] w-full max-w-sm overflow-hidden rounded-lg bg-green-500 shadow-lg ring-1 ring-black ring-opacity-5">
            <div className="p-4">
